    ...
    try:
        with open(filename, 'r', encoding='utf-8') as file:
            ...
            for key, value in data.items():
                ...
                if search_string in value_str or 'dstip' in value_str:
...
# Function calls
found_files = find_string_in_json(folder_path, search_string)
aggregate_and_export_data(folder_path, found_files, search_string, output_file_path)
