...
def find_string_in_json(folder_path, search_string, output_file):
    found_files = []
...
def aggregate_and_export_data(folder_path, found_files, search_string, additional_fields, output_file):
    aggregated_data = []
...
additional_fields = ['dstip', 'tenant_name', 'appid_name', 'srcport', 'totalbytes', 'totalpackets']
...
# Function calls
found_files = find_string_in_json(folder_path, search_string, output_file_path)
aggregate_and_export_data(folder_path, found_files, search_string, additional_fields, output_file_path)
